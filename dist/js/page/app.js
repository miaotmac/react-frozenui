...
/***/ function(module, exports, __webpack_require__) {
	...
	var injectTapEventPlugin = __webpack_require__(161);
	...
	var SearchBar = React.createClass({
	  ...
	  renderSearchBar: function renderSearchBar(classSet) {
	    return React.createElement(
	      'div',
	      { className: classNames(this.props.className, classNames("ui-searchbar-wrap ui-border-b", { focus: this.state.isFocus })) },
	      React.createElement(
	        'div',
	        { className: "ui-searchbar ui-border-radius", onTouchTap: this.handleTouchTap },
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { ref: "theSearchbarInput", value: "", type: this.props.type, placeholder: this.props.placeholder, autocapitalize: "off" })
	        ),
	        React.createElement('i', { className: "ui-icon-close" })
	      ),
	      React.createElement(
	        'button',
	        { className: "ui-searchbar-cancel", onTouchTap: this.handleTouchTapCancel },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function injectTapEventPlugin () {
	  ...
	  __webpack_require__(69).injection.injectEventPluginsByName({
	    "ResponderEventPlugin": __webpack_require__(162),
	    "TapEventPlugin":       __webpack_require__(163)
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TouchEventUtils = __webpack_require__(164);
